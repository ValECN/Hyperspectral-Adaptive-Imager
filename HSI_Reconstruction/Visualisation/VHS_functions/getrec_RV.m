function rect = getrec_RV(varargin)
...
if (nargin < 1)
    ...
    if ~ishghandle(varargin{1})
        CleanGlobals;
        error(message('getrec_RV:expectedHandle'));
    end
    ...
    otherwise
        CleanGlobals;
        error(message('getrec_RV:expectedFigureOrAxesHandle'));
    end
end
...
set(GETRECT_FIG, ...
    'Pointer', 'crosshair', ...
    'WindowButtonDownFcn', 'getrec_RV(''ButtonDown'');');
...
case 'trap'
    ...
    error(message('getrec_RV:interruptedMouseSelection'));
...
set(GETRECT_FIG, 'WindowButtonMotionFcn', 'getrec_RV(''ButtonMotion'');', ...
                 'WindowButtonUpFcn', 'getrec_RV(''ButtonUp'');');
